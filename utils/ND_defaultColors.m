...
%
%
% WZ: Current version just copied from the PLDAPS function. We might want
% to adjust values, therefore make it our own default function...
...
% WZ: This if switch does not make any sense to me, it asks three times the same condition...
