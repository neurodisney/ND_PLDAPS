...
if isfield(p.defaultParameters.display, 'useCustomOrigin') && p.defaultParameters.display.useCustomOrigin ~= 0
    ...
    p.defaultParameters.display.coordMatrix = (eye(3) + [0 0 xTrans; ...
                                                         0 0 yTrans; ...
                                                         0 0 0     ]) * p.defaultParameters.display.coordMatrix; 
...
if isfield(p.defaultParameters.display, 'useDegreeUnits') && p.defaultParameters.display.useDegreeUnits ~= 0
    ...
    if p.defaultParameters.display.useDegreeUnits == 1
        ...
        % Update the coordinate matrix
        p.defaultParameters.display.coordMatrix = [xScaleFactor 0              0; ...
                                                  0            yScaleFactor   0; ...
                                                  0            0              1] * p.defaultParameters.display.coordMatrix;
