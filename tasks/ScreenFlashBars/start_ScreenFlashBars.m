function p = start_ScreenFlashBars(subjname, rig, ~)
...
SS.task.TaskDef    = 'ScreenFlashBars_taskdef';  % function that provides task specific parameter definitions
SS.task.AfterTrial = 'ScreenFlashBars_aftertrial';  % function that provides runs task specific actions after a trial
SS.plot.routine    = 'ScreenFlashBars_plots';    % function for online plotting of session progress
