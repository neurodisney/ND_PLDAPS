...
p.trial.reward.Dur            = 0.3; %initial reward duration
...
% Main trial timings
p.trial.task.stimLatency      = ND_GetITI(0.25,  1.75,  [], [], 1, 0.20); % Time from fixation onset to stim appearing
...
p.trial.task.Timing.ITI       = ND_GetITI(0.7,  1.5,  [], [], 1, 0.10);
