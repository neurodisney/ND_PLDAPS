...
% Main trial timings
p.trial.task.stimLatency      = ND_GetITI(0.75,  2.50,  [], [], 1, 0.20); % Time from fixation onset to stim appearing
...
p.trial.stim.GRATING.fixWin = 2.75;  %*p.trial.stim.GRATING.radius;
