function p = start_get_joy(subjname, rig, experimenter)
...
SS.task.TaskDef  = 'get_joy_taskdef';  % function that provides task specific parameter definitions
...
SS.behavior.fixation.FixScale = [10, 10]; 
