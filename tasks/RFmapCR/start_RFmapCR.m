function p = start_RFmapCR(subjname, rig)
...
SS.task.TaskDef    = 'RFmapCR_taskdef';  % function that provides task specific parameter definitions
SS.task.AfterTrial = 'RFmapCR_aftertrial';  % function that provides runs task specific actions after a trial
