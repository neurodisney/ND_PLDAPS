...
switch p.trial.stim.RFmeth
    case 'coarse'
        %p.trial.stim.coarse.ori      = [45, 90, 135];   % orient of grating
        p.trial.stim.coarse.ori      = 0;   % orient of grating
        p.trial.stim.coarse.radius   = 0.85;      % size of grating 
        ...
        p.trial.stim.coarse.xRange   = [8, 10];
        p.trial.stim.coarse.yRange   = [-1, 1];
...
p.trial.task.stimOnTime     = 0.10;   % How long each stimulus is presented
p.trial.task.stimOffTime    = 0.20;   % Gaps between succesive stimuli
