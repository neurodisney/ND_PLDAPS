...
if(isempty(state))
    ...
    % This carries out standard routin|| 'referenceB' || 'referenceC'es, mainly in respect to hardware interfacing.
    ...
    switch state
        % ------------------------------------p.defaultParameters.task.RandomQuadp.defaultParameters.task.RandomQuad------------------------------------%
        ...
        % ----------------------------------------------------------------%
        %case p.trial.pldaps.trialStates.HemiframeDraw
...
function TaskSetUp(p)
    ...
    p.trial.stim.Ref.Contrast = 0.3; 
    % p.trial.stim.Ref.sFreq = 4; % OPTION hard code spatial frequency in cycles per degree
    
    % define names for gratings   
        p.trial.stim.SaccadeTarget     = 'target';
        p.trial.stim.SaccadeDistractorA = 'referenceA';
        p.trial.stim.SaccadeDistractorB = 'referenceB';
        p.trial.stim.SaccadeDistractorC = 'referenceC';

    % assign positions on screen
    if p.defaultParameters.task.ProbHemi == 1;
        p.trial.stim.AttIn       = datasample(p.defaultParameters.task.AttProb, 1);
    end
    
    if p.trial.stim.AttIn == 'y'
        p.trial.stim.Hemi = p.defaultParameters.stim.AttQuad;
    elseif p.trial.stim.AttIn == 'n';
        p.trial.stim.Hemi = datasample(p.defaultParameters.stim.QuadLst, 1);
    end
    
    if p.trial.stim.Hemi == 'ur'
        p.trial.stim.Trgt.Pos = [ 1* p.trial.stim.PosX, 1* p.trial.stim.PosY];
        p.trial.stim.RefA.Pos  = [ 1* p.trial.stim.PosX, -1* p.trial.stim.PosY];
        p.trial.stim.RefB.Pos = [-1* p.trial.stim.PosX, -1* p.trial.stim.PosY];
        p.trial.stim.RefC.Pos  = [-1* p.trial.stim.PosX, 1* p.trial.stim.PosY];
    elseif p.trial.stim.Hemi == 'ul'
        p.trial.stim.Trgt.Pos = [ -1* p.trial.stim.PosX, 1* p.trial.stim.PosY];
        p.trial.stim.RefA.Pos  = [ 1* p.trial.stim.PosX, 1* p.trial.stim.PosY];
        p.trial.stim.RefB.Pos = [1* p.trial.stim.PosX, -1* p.trial.stim.PosY];
        p.trial.stim.RefC.Pos  = [-1* p.trial.stim.PosX, -1* p.trial.stim.PosY]; 
    elseif p.trial.stim.Hemi == 'll'
        p.trial.stim.Trgt.Pos = [ -1* p.trial.stim.PosX, -1* p.trial.stim.PosY];
        p.trial.stim.RefA.Pos  = [ -1* p.trial.stim.PosX, 1* p.trial.stim.PosY];
        p.trial.stim.RefB.Pos = [1* p.trial.stim.PosX, 1* p.trial.stim.PosY];
        p.trial.stim.RefC.Pos  = [1* p.trial.stim.PosX, -1* p.trial.stim.PosY];
    ...
    % assign orientations
        ...
        p.trial.stim.Trgt.Ori = datasample(p.defaultParameters.stim.OriLst,1);
       
        if p.trial.stim.Trgt.Ori < 45;
            p.trial.stim.RefA.Ori  = p.trial.stim.Trgt.Ori + 45;
            p.trial.stim.RefB.Ori = p.trial.stim.Trgt.Ori + 90;
            p.trial.stim.RefC.Ori  = p.trial.stim.Trgt.Ori + 135;
         
        elseif p.trial.stim.Trgt.Ori >= 45 && p.trial.stim.Trgt.Ori < 90;
                 p.trial.stim.RefA.Ori  = p.trial.stim.Trgt.Ori + 45;
                 p.trial.stim.RefB.Ori = p.trial.stim.Trgt.Ori + 90;
                 p.trial.stim.RefC.Ori  = p.trial.stim.Trgt.Ori -45;
             
        elseif p.trial.stim.Trgt.Ori >= 90 && p.trial.stim.Trgt.Ori < 135;
                    p.trial.stim.RefA.Ori  = p.trial.stim.Trgt.Ori + 45;
                    p.trial.stim.RefB.Ori = p.trial.stim.Trgt.Ori -45;
                    p.trial.stim.RefC.Ori  = p.trial.stim.Trgt.Ori -90;
   ...
   % Create Target grating  
    ...
    % Create Reference grating A (parameter in question is kept constant)
    p.trial.stim.GRATING.sFreq     = p.trial.stim.Ref.sFreq;
    p.trial.stim.GRATING.ori       = p.trial.stim.RefA.Ori;
    %p.trial.stim.GRATING.ori       = 120;
    p.trial.stim.GRATING.pos       = p.trial.stim.RefA.Pos;
    p.trial.stim.GRATING.contrast  = p.trial.stim.Ref.Contrast;
    p.trial.stim.referenceA         = pds.stim.Grating(p);

 % Create Reference grating B (parameter in question is kept constant)
    p.trial.stim.GRATING.sFreq     = p.trial.stim.Ref.sFreq;
    p.trial.stim.GRATING.ori       = p.trial.stim.RefB.Ori;
    %p.trial.stim.GRATING.ori       = 120;
    p.trial.stim.GRATING.pos       = p.trial.stim.RefB.Pos;
    p.trial.stim.GRATING.contrast  = p.trial.stim.Ref.Contrast;
    p.trial.stim.referenceB         = pds.stim.Grating(p);
  
 % Create Reference grating A (parameter in question is kept constant)  
    p.trial.stim.GRATING.sFreq     = p.trial.stim.Ref.sFreq;
    p.trial.stim.GRATING.ori       = p.trial.stim.RefC.Ori;
    %p.trial.stim.GRATING.ori       = 120;
    p.trial.stim.GRATING.pos       = p.trial.stim.RefC.Pos;
    p.trial.stim.GRATING.contrast  = p.trial.stim.Ref.Contrast;
    p.trial.stim.referenceC         = pds.stim.Grating(p);
...
function TaskDesign(p)
    ...
    switch p.trial.CurrEpoch
        ...
        %% Items shown, animal has to decide what's the target and make a saccade towards it
            % Animal has not yet sacdatasample(['ul', 'ur', 'll', 'lr'], 1)caded to target
        ...
        %% Response occurred, check if it was the correct one
            ...
            % Animal has not yet saccaded to target
                ...
                elseif(p.trial.stim.(p.trial.stim.SaccadeDistractorA).looking)
                % wrong item chosen
                    % Play breakfix sound
                    %pds.audio.playDP(p, 'incorrect','left');
                ...
                elseif(p.trial.stim.(p.trial.stim.SaccadeDistractorB).looking)
                % wrong item chosen
                    % Play breakfix sound
                    %pds.audio.playDP(p, 'incorrect','left');
                    ...
                    elseif(p.trial.stim.(p.trial.stim.SaccadeDistractorC).looking)
                % wrong item chosen
                    % Play breakfix sound
                    %pds.audio.playDP(p, 'incorrect','left');
                ...
                % returned in time tdatasample(['ul', 'ur', 'll', 'lr'], 1)o fixation spot, not considered a response saccade yet
                     ND_SwitchEpoch(p, 'WaitSaccade');
                end
            else  % stimFix == 1
        ...
        %% finish trial and error handling
            ...
            elseif(~isnan(p.trial.stim.referenceA.EV.FixStart))
                p.trial.EV.FixStimStart = p.trial.stim.referenceA.EV.FixStart;
                p.trial.EV.FixStimStop  = p.trial.stim.referenceA.EV.FixBreak;
                
           elseif(~isnan(p.trial.stim.referenceB.EV.FixStart))
                p.trial.EV.FixStimStart = p.trial.stim.referenceB.EV.FixStart;
                p.trial.EV.FixStimStop  = p.trial.stim.referenceB.EV.FixBreak;
                
            elseif(~isnan(p.trial.stim.referenceC.EV.FixStart))
                p.trial.EV.FixStimStart = p.trial.stim.referenceC.EV.FixStart;
                p.trial.EV.FixStimStop  = p.trial.stim.referenceC.EV.FixBreak;
            end
...
% 
%                 p.trial.stim.referenceA.on        = 1;
%                 p.trial.stim.reference.fixActive = 1;
%                 
%                 p.trial.stim.referenceB.on        = 1;
%                 p.trial.stim.reference.fixActive = 1;
%                 
%                 p.trial.stim.referenceC.on        = 1;
%                 p.trial.stim.reference.fixActive = 1;
    ...
    if(val ~= p.trial.task.stimState)
        ...
        switch val
            case 0
                ...
                p.trial.stim.referenceA.on        = 0;
                p.trial.stim.referenceB.on        = 0;
                p.trial.stim.referenceC.on        = 0;
