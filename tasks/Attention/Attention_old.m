...
% Nilupaer Abudukeyoumu May/June 2021
...
function TaskSetUp(p)
   ...
   % end
    ...
    %if(p.trial.task.RandomHemi == 1)
     %   p.trial.stim.Hemi = datasample(['r', 'l'], 0);
   % end

    % define both gratings
    p.trial.stim.Ref.Contrast = 0.3; 
   % p.trial.stim.Ref.Contrast = datasample[p.trial.stim.Ref.Contrast1, p.trial.stim.Ref.Contrast2, p.trial.stim.Ref.Contrast3]; 
