function p = start_DetectGratCR(subjname, rig)
...
SS.task.TaskDef    = 'DetectGratCR_taskdef';     % function that provides task specific parameter definitions
SS.task.AfterTrial = 'DetectGratCR_aftertrial';  % function that provides runs task specific actions after a trial
SS.plot.routine    = 'DetectGratCR_plots';       % function for online plotting of session progress
