function p = DetectGratCR_init(p)
...
p.defaultParameters.stim.PosY = -2.8; % Corey Hack: to get hardcoded single position
p.defaultParameters.stim.PosX = -3.4; %Corey Hack: to get hardcoded single position
