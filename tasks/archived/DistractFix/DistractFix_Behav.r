...
DistractFix_Behav = function(datadir=NA, fname=NA) {
...
if(interactive()) {
  ...
  dev.copy(pdf, 'DistractFix.pdf', 19.5, 10.5, pointsize=10, title='DistractFix_Behav')
}
...
if(!interactive()) {
  ...
  # Run the function
  DistractFix_Behav(datadir, fname)
}
