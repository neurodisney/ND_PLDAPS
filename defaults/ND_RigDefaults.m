...
switch rig
    case 1
        ...
        SS.eyeCalib.defaultGain      = [-15.2816 -14.4106];  % default gain, used if no calibration points are entered
        SS.eyeCalib.defaultOffset    = [-0.9930, -1.5408];    % default offset, used if no calibration points are entered
