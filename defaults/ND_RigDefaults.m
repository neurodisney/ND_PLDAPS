...
SS.eyeCalib.defaultGain              = [7.0168 -6.8957];  % default gain, used if no calibration points are entered
SS.eyeCalib.defaultOffset            = [0.0711 0.5936];    % default offset, used if no calibration points are entered
