...
switch rig
    case 1
        ...
        SS.eyeCalib.defaultGain      = [19.0896 -18.8710];  % default gain, used if no calibration points are entered
        SS.eyeCalib.defaultOffset    = [-0.8429 -1.9815];    % default offset, used if no calibration points are entered
