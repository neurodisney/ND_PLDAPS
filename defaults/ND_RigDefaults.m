...
switch rig
    case 1
        ...
        SS.eyeCalib.defaultGain      = [18.7748 -20.6381];  % default gain, used if no calibration points are entered
        SS.eyeCalib.defaultOffset    = [-1.9147 -1.4490];    % default offset, used if no calibration points are entered
