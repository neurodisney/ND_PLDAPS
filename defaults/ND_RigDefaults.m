...
SS.eyeCalib.defaultGain              = [-3.6259 -3.2595];  % default gain, used if no calibration points are entered
SS.eyeCalib.defaultOffset            = [0.1371 -1.6244];    % default offset, used if no calibration points are entered
